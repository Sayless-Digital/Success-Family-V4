...
COMMENT ON FUNCTION public.process_referral_bonus IS 'Processes referral bonus, credits earnings_points (not points_balance), deducts from platform liquid revenue, and creates referral_expense ledger entry';
