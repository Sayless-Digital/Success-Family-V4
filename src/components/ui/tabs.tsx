...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-center rounded-md bg-gradient-to-br from-white/10 to-transparent backdrop-blur-md border border-white/20 p-1 text-white",
      className
    )}
    {...props}
  />
