...
>(({ className, children, hideCloseButton = false, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      ...
      {!hideCloseButton && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 text-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-white/20 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-white/20 data-[state=open]:text-white cursor-pointer" tabIndex={-1}>
          <X className="h-4 w-4" />
